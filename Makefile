...
# Generated by qmake (3.0) (Qt 5.0.1) on: Thu Jan 30 09:56:17 2014
...
$(TARGET): ui_translator.h ui_about.h ui_convertfiles.h ui_preferences.h $(OBJECTS)  
...
dist: 
	@test -d .tmp/mltranslator1.0.0 || $(MKDIR) .tmp/mltranslator1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/mltranslator1.0.0/ && $(COPY_FILE) --parents icons.qrc themes.qrc .tmp/mltranslator1.0.0/ && $(COPY_FILE) --parents translator.h about.h convertfiles.h preferences.h .tmp/mltranslator1.0.0/ && $(COPY_FILE) --parents main.cpp translator.cpp about.cpp convertfiles.cpp preferences.cpp .tmp/mltranslator1.0.0/ && $(COPY_FILE) --parents translator.ui about.ui convertfiles.ui preferences.ui .tmp/mltranslator1.0.0/ && $(COPY_FILE) --parents mltranslator_mal.ts mltranslator_eng.ts .tmp/mltranslator1.0.0/ && (cd `dirname .tmp/mltranslator1.0.0` && $(TAR) mltranslator1.0.0.tar mltranslator1.0.0 && $(COMPRESS) mltranslator1.0.0.tar) && $(MOVE) `dirname .tmp/mltranslator1.0.0`/mltranslator1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/mltranslator1.0.0
...
compiler_moc_header_make_all: moc_translator.cpp moc_about.cpp moc_convertfiles.cpp moc_preferences.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_translator.cpp moc_about.cpp moc_convertfiles.cpp moc_preferences.cpp
...
compiler_uic_make_all: ui_translator.h ui_about.h ui_convertfiles.h ui_preferences.h
compiler_uic_clean:
	-$(DEL_FILE) ui_translator.h ui_about.h ui_convertfiles.h ui_preferences.h
...
install_target: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/sreekumar/mltranslator/mltranslator $(INSTALL_ROOT)/usr/bin/
...
install_icon: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/icons || $(MKDIR) $(INSTALL_ROOT)/usr/share/icons 
	-$(INSTALL_FILE) /home/sreekumar/mltranslator/misc/mltranslator.png $(INSTALL_ROOT)/usr/share/icons/
...
install_desktopfile: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/applications || $(MKDIR) $(INSTALL_ROOT)/usr/share/applications 
	-$(INSTALL_FILE) /home/sreekumar/mltranslator/misc/mltranslator.desktop $(INSTALL_ROOT)/usr/share/applications/
