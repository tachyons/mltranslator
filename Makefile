...
# Generated by qmake (3.0) (Qt 5.0.2) on: Sun Jan 26 15:40:45 2014
...
SOURCES       = main.cpp \
		translator.cpp \
		about.cpp \
		convertfiles.cpp qrc_icons.cpp \
		moc_translator.cpp \
		moc_about.cpp \
...
$(TARGET): ui_translator.h ui_about.h ui_convertfiles.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/mltranslator1.0.0/ && $(COPY_FILE) --parents icons.qrc .tmp/mltranslator1.0.0/ && $(COPY_FILE) --parents translator.h about.h convertfiles.h .tmp/mltranslator1.0.0/ && $(COPY_FILE) --parents main.cpp translator.cpp about.cpp convertfiles.cpp .tmp/mltranslator1.0.0/ && $(COPY_FILE) --parents translator.ui about.ui convertfiles.ui .tmp/mltranslator1.0.0/ && $(COPY_FILE) --parents mltranslator_mal.ts mltranslator_eng.ts .tmp/mltranslator1.0.0/ && (cd `dirname .tmp/mltranslator1.0.0` && $(TAR) mltranslator1.0.0.tar mltranslator1.0.0 && $(COMPRESS) mltranslator1.0.0.tar) && $(MOVE) `dirname .tmp/mltranslator1.0.0`/mltranslator1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/mltranslator1.0.0
...
compiler_moc_header_make_all: moc_translator.cpp moc_about.cpp moc_convertfiles.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_translator.cpp moc_about.cpp moc_convertfiles.cpp
...
compiler_uic_make_all: ui_translator.h ui_about.h ui_convertfiles.h
compiler_uic_clean:
	-$(DEL_FILE) ui_translator.h ui_about.h ui_convertfiles.h
