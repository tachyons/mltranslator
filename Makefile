...
# Generated by qmake (3.0) (Qt 5.0.2) on: Fri Jan 31 23:39:23 2014
...
$(TARGET): ui_translator.h ui_about.h ui_convertfiles.h ui_preferences.h ui_newword.h ui_newparadigm.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/mltranslator1.0.0/ && $(COPY_FILE) --parents icons.qrc themes.qrc .tmp/mltranslator1.0.0/ && $(COPY_FILE) --parents translator.h about.h convertfiles.h preferences.h newword.h newparadigm.h .tmp/mltranslator1.0.0/ && $(COPY_FILE) --parents main.cpp translator.cpp about.cpp convertfiles.cpp preferences.cpp newword.cpp newparadigm.cpp .tmp/mltranslator1.0.0/ && $(COPY_FILE) --parents translator.ui about.ui convertfiles.ui preferences.ui newword.ui newparadigm.ui .tmp/mltranslator1.0.0/ && $(COPY_FILE) --parents mltranslator_mal.ts mltranslator_eng.ts .tmp/mltranslator1.0.0/ && (cd `dirname .tmp/mltranslator1.0.0` && $(TAR) mltranslator1.0.0.tar mltranslator1.0.0 && $(COMPRESS) mltranslator1.0.0.tar) && $(MOVE) `dirname .tmp/mltranslator1.0.0`/mltranslator1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/mltranslator1.0.0
...
compiler_moc_header_make_all: moc_translator.cpp moc_about.cpp moc_convertfiles.cpp moc_preferences.cpp moc_newword.cpp moc_newparadigm.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_translator.cpp moc_about.cpp moc_convertfiles.cpp moc_preferences.cpp moc_newword.cpp moc_newparadigm.cpp
...
compiler_uic_make_all: ui_translator.h ui_about.h ui_convertfiles.h ui_preferences.h ui_newword.h ui_newparadigm.h
compiler_uic_clean:
	-$(DEL_FILE) ui_translator.h ui_about.h ui_convertfiles.h ui_preferences.h ui_newword.h ui_newparadigm.h
